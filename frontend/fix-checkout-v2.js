...
export async function POST(request: NextRequest) {
  try {
    ...
    // Removendo auto_return para evitar erro
...
const filePath = path.join(__dirname, 'app/api/infoproduto/checkout/route.ts');
fs.writeFileSync(filePath, content, 'utf8');

console.log('✅ Arquivo atualizado - auto_return removido!');
